...
public class HomeWork2 {
    ...
    public void fromCssToxPath() {
        ...
        wd.findElement(By.xpath("//*[@href]"));

        wd.findElement(By.cssSelector("[href ^='/ho']"));
        wd.findElement(By.xpath("//*[starts-with(@href,'/ho')]"));

        wd.findElement(By.cssSelector("div.focus"));//start
        wd.findElement(By.xpath("//div[contains(@class,'focus')]"));//"//div[@class='focus']"
    ...
    public void fromXPathToCss() {
        ...
        wd.findElement(By.cssSelector("divdivimg[src='paris.jpg']")); //*
